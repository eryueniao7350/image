...
class DataCleaner:
    ...
    CATEGORY_KEYWORDS: Dict[str, List[str]] = {
        ...
        "prompt-library": [
            "prompt library", "prompt-library", "prompts library",
            "prompt collection", "prompt-collection", "prompt repository",
            "prompt repo", "prompt template", "prompt templates",
            "system prompts", "awesome prompts", "open prompts",
        ],
        "agent-tool": [
